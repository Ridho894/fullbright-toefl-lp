...
const UNI_LOGOS: { src: string; alt: string }[] = [
  ...
  { src: '/assets/unair.webp', alt: 'Universitas Airlangga' },
  { src: 'https://www.unpad.ac.id/wp-content/uploads/2025/12/logo-unpad-duo.svg', alt: 'Universitas Padjadjaran' },
  { src: '/assets/logos/its.png', alt: 'Institut Teknologi Sepuluh Nopember' },
...
const KEYFRAMES = `
  ...
  @layer base {
    ...
    body { margin: 0; background: #fff; font-family: 'Nunito', system-ui, sans-serif; }
...
export default function LandingPage({
  ...
  const [lmsPlaying, setLmsPlaying] = useState<boolean>(false);
  ...
  return (
    <>
      <Head title="Kelas TOEFL Skor 500+ untuk Submission Beasiswa dan Kerja">
        ...
        <link href="https://fonts.googleapis.com/css2?family=Nunito:ital,opsz,wght@0,6..12,400;0,6..12,600;0,6..12,700;0,6..12,800;0,6..12,900;1,6..12,400&display=swap" rel="stylesheet" />
        <meta headKey="description" name="description" content="Persiapkan TOEFL skor 500+ untuk submission beasiswa dan kerja bersama Full Bright Indonesia." />
      </Head>
      ...
      <div className="[min-height:100vh] [background:#fff] [font-family:Nunito,system-ui,sans-serif]">
        ...
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 50 }}>
          {flashVisible ? (
            <div ref={bannerRef}>
              <TrackedCTA id="urgency-banner" href="#pricing" zone="sticky" action="scroll" label="Flash Sale September" className="[display:flex] [align-items:center] [justify-content:center] [flex-wrap:nowrap] [gap:8px] [background:#C10707] [padding:8px_12px] [text-align:center] [text-decoration:none] [white-space:nowrap] [overflow:hidden] max-[500px]:[padding:10px_12px]">
          ...
          <header style={css(navStyle(scrolled))}>
            <div className="[max-width:1152px] [margin:0_auto] [height:64px] [display:flex] [align-items:center] [justify-content:space-between] [padding:0_24px]">
              <a href="#" className="[display:flex] [align-items:center] [text-decoration:none]">
                <img src="/assets/Logo-Fullbright.webp" alt="Full Bright Indonesia" className="[height:auto] [width:160px] [object-fit:contain]" />
              </a>
              <TrackedCTA href="#pricing" zone="nav" action="scroll" label="Amankan Seat" className="[display:flex] [flex-direction:column] [justify-content:center] [gap:1px] [border-radius:9999px] [background:#D70808] [box-shadow:0_6px_16px_rgba(215,8,8,0.35)] [text-decoration:none] [padding:7px_16px]">
        ...
        <div aria-hidden="true" style={{ height: bannerH + 64 }} />
        ...
        <section id="hero" className="[position:relative] [overflow:hidden] [background:linear-gradient(160deg,#fff_55%,#FFF5F5_100%)]">
              ...
              <div className="[display:flex] [flex-direction:column] [gap:16px] [grid-column:1] [position:relative] [z-index:1]">
                ...
                <div id="hero-cta-row" className="[display:flex] [flex-direction:column] [gap:12px]">
                  <div id="hero-cta-buttons" className="[display:flex] [flex-wrap:wrap] [gap:12px] max-[500px]:[flex-direction:column]">
                    <TrackedCTA href="#pricing" zone="hero" action="scroll" label="Mulai Persiapan TOEFL" className="[display:inline-flex] [align-items:center] [justify-content:center] [gap:8px] [font-weight:700] [border-radius:16px] [padding:14px_28px] [font-size:16px] [color:#fff] [background:#D70808] [box-shadow:0_4px_20px_rgba(215,8,8,0.35)] [text-decoration:none] max-[500px]:[font-size:clamp(12px,3.6vw,16px)] max-[500px]:[padding:clamp(10px,3vw,14px)_clamp(16px,5vw,28px)] max-[500px]:[width:100%] max-[500px]:[box-sizing:border-box]">Mulai Persiapan TOEFL →</TrackedCTA>
                    <TrackedCTA href="#testimonials" zone="hero" action="scroll" label="Lihat Bukti Alumni" className="[display:inline-flex] [align-items:center] [justify-content:center] [gap:8px] [font-weight:700] [border-radius:16px] [padding:14px_28px] [font-size:16px] [color:#151515] [border:2px_solid_#D70808] [text-decoration:none] max-[500px]:[font-size:clamp(12px,3.6vw,16px)] max-[500px]:[padding:clamp(10px,3vw,14px)_clamp(16px,5vw,28px)] max-[500px]:[width:100%] max-[500px]:[box-sizing:border-box]">Lihat Bukti Alumni →</TrackedCTA>
                  </div>
          ...
          <div className="[position:relative] [display:flex] [justify-content:center] [padding-bottom:4px] max-[899px]:[margin-top:-78px] max-[899px]:[padding-bottom:10px]">
        ...
        <div className="[background:#F3F3F3] [padding:32px_0] [overflow:hidden]">
          ...
          <div className="[overflow:hidden] [mask-image:linear-gradient(to_right,transparent,black_6%,black_94%,transparent)] [-webkit-mask-image:linear-gradient(to_right,transparent,black_6%,black_94%,transparent)]">
            <div className="[display:flex] [width:max-content] [animation:infiniteScroll_30s_linear_infinite]">
              {UNI_LOGOS.concat(UNI_LOGOS).map((logo, i) => (
                <img key={`${logo.alt}-${i}`} src={logo.src} alt={logo.alt} width={110} height={64} loading="lazy" className="[width:110px] [height:64px] [margin:0_20px] [flex-shrink:0] [object-fit:contain]" />
              ))}
            </div>
          </div>
        </div>
          ...
          <div className="[max-width:1152px] [margin:0_auto]">
            ...
            <div className="[text-align:center]">
              <div className="[display:flex] [flex-wrap:wrap] [gap:12px] [justify-content:center]">
                <TrackedCTA href="#pricing" zone="midpage" action="scroll" label="Gabung Sekarang" className="[display:inline-flex] [align-items:center] [justify-content:center] [gap:8px] [font-weight:700] [border-radius:16px] [padding:14px_28px] [font-size:16px] [color:#fff] [background:#D70808] [box-shadow:0_4px_20px_rgba(215,8,8,0.35)] [text-decoration:none]">Gabung Sekarang →</TrackedCTA>
                <TrackedCTA href="#testimonials" zone="midpage" action="scroll" label="Lihat Bukti Alumni" className="[display:inline-flex] [align-items:center] [justify-content:center] [gap:8px] [font-weight:700] [border-radius:16px] [padding:14px_28px] [font-size:16px] [color:#151515] [border:2px_solid_#D70808] [text-decoration:none]">Lihat Bukti Alumni →</TrackedCTA>
              </div>
          ...
          <div className="[max-width:672px] [margin:0_auto]">
            ...
            <div className="[margin:0_auto_32px] [max-width:420px] [display:flex] [flex-direction:column]">
                ...
                <div className="[display:flex] [cursor:pointer] [flex-direction:column] [align-items:center] [gap:10px] [padding:20px_0] [border-bottom:1px_solid_#e5e7eb]" onClick={() => setLightboxIdx(0)}>
                  ...
                  <div className="[border-radius:14px] [box-shadow:0_6px_24px_rgba(0,0,0,0.18)] [aspect-ratio:1/1] [width:100%] [overflow:hidden]"><img src="/assets/toefl1.webp" alt="" className="[display:block] [width:100%] [height:100%] [object-fit:cover]" /></div>
                </div>
                ...
                <div className="[display:flex] [cursor:pointer] [flex-direction:column] [align-items:center] [gap:10px] [padding:20px_0] [border-bottom:1px_solid_#e5e7eb]" onClick={() => setLightboxIdx(1)}>
                  ...
                  <div className="[border-radius:14px] [box-shadow:0_6px_24px_rgba(0,0,0,0.18)] [aspect-ratio:1/1] [width:100%] [overflow:hidden]"><img src="/assets/toefl2.webp" alt="" className="[display:block] [width:100%] [height:100%] [object-fit:cover]" /></div>
                </div>
                ...
                <div className="[display:flex] [cursor:pointer] [flex-direction:column] [align-items:center] [gap:10px] [padding:20px_0] [border-bottom:1px_solid_#e5e7eb]" onClick={() => setLightboxIdx(2)}>
                  ...
                  <div className="[border-radius:14px] [box-shadow:0_6px_24px_rgba(0,0,0,0.18)] [aspect-ratio:1/1] [width:100%] [overflow:hidden]"><img src="/assets/toefl3.webp" alt="" className="[display:block] [width:100%] [height:100%] [object-fit:cover]" /></div>
                </div>
            ...
            <div className="[text-align:center]">
              <div className="[display:flex] [flex-wrap:wrap] [gap:12px] [justify-content:center]">
                <TrackedCTA href="#pricing" zone="midpage" action="scroll" label="Gabung Sekarang" className="[display:inline-flex] [align-items:center] [justify-content:center] [gap:8px] [font-weight:700] [border-radius:16px] [padding:14px_28px] [font-size:16px] [color:#fff] [background:#D70808] [box-shadow:0_4px_20px_rgba(215,8,8,0.35)] [text-decoration:none]">Gabung Sekarang →</TrackedCTA>
                <TrackedCTA href="#testimonials" zone="midpage" action="scroll" label="Lihat Lebih Banyak Bukti" className="[display:inline-flex] [align-items:center] [justify-content:center] [gap:8px] [font-weight:700] [border-radius:16px] [padding:14px_28px] [font-size:16px] [color:#151515] [border:2px_solid_#D70808] [text-decoration:none]">Lihat Lebih Banyak Bukti →</TrackedCTA>
              </div>
              <div className="[margin-top:12px] [display:flex] [align-items:center] [justify-content:center] [flex-wrap:wrap] [gap:8px_12px]">
                <span className="[display:flex] [align-items:center] [gap:4px] [font-size:12px] [font-weight:600] [color:#6b7280]">★★★★★<span className="[margin-left:4px]">4.9/5 Google Review</span></span>
                <span className="[font-size:12px] [color:#6b7280]">•</span><span className="[font-size:12px] [font-weight:600] [color:#6b7280]">45.000+ Alumni Sukses</span>
        ...
        <section id="lms" className="[background:#fff] [padding:80px_24px]">
          <div className="[max-width:1152px] [margin:0_auto]">
            ...
            <div className="[position:relative] [max-width:1040px] [margin:0_auto_40px] [overflow:hidden] [border-radius:18px] [background:#151515] [box-shadow:0_8px_28px_rgba(0,0,0,0.18)] [line-height:0]">
              <video ref={lmsVideoRef} className="[display:block] [width:100%] [aspect-ratio:16/9] [object-fit:cover] [background:#151515]" src="https://demo-fullbright.b-cdn.net/NEW.mp4" controls={lmsPlaying} playsInline preload="metadata" onPlay={() => setLmsPlaying(true)} onPause={() => setLmsPlaying(false)} />
              {!lmsPlaying ? (
                <button type="button" onClick={playLmsVideo} className="[position:absolute] [inset:0] [display:flex] [align-items:center] [justify-content:center] [border:0] [background:rgba(21,21,21,0.22)] [cursor:pointer] [transition:background_0.2s_ease] hover:[background:rgba(21,21,21,0.32)]">
        ...
        {/* Why Full Bright */}
        <section id="why" className="[background:#F3F3F3] [padding:80px_24px]">
          <div className="[max-width:1152px] [margin:0_auto]">
            <div className="[text-align:center] [margin-bottom:48px]">
            ...
            <div className="[max-width:1152px] [margin:0_auto]">
              ...
              <div className="[margin-bottom:56px] [overflow:hidden] [mask-image:linear-gradient(to_right,transparent,black_6%,black_94%,transparent)] [-webkit-mask-image:linear-gradient(to_right,transparent,black_6%,black_94%,transparent)]">
                <div className="[display:flex] [width:max-content] [animation:infiniteScroll_35s_linear_infinite]">
                    ...
                    <div className="[margin:0_8px] [display:flex] [flex-shrink:0] [flex-direction:column] [align-items:center] [gap:8px]">
                      ...
                      <div className="[width:130px] [border-radius:12px] [box-shadow:0_4px_16px_rgba(0,0,0,0.15)] [aspect-ratio:9/16] [overflow:hidden]"><img src="/assets/toefl1.webp" alt="" className="[display:block] [width:100%] [height:100%] [object-fit:cover]" /></div>
                    </div>
                    ...
                    <div className="[margin:0_8px] [display:flex] [flex-shrink:0] [flex-direction:column] [align-items:center] [gap:8px]">
                      ...
                      <div className="[width:130px] [border-radius:12px] [box-shadow:0_4px_16px_rgba(0,0,0,0.15)] [aspect-ratio:9/16] [overflow:hidden]"><img src="/assets/toefl2.webp" alt="" className="[display:block] [width:100%] [height:100%] [object-fit:cover]" /></div>
                    </div>
                    ...
                    <div className="[margin:0_8px] [display:flex] [flex-shrink:0] [flex-direction:column] [align-items:center] [gap:8px]">
                      ...
                      <div className="[width:130px] [border-radius:12px] [box-shadow:0_4px_16px_rgba(0,0,0,0.15)] [aspect-ratio:9/16] [overflow:hidden]"><img src="/assets/toefl3.webp" alt="" className="[display:block] [width:100%] [height:100%] [object-fit:cover]" /></div>
                    </div>
                    ...
                    <div className="[margin:0_8px] [display:flex] [flex-shrink:0] [flex-direction:column] [align-items:center] [gap:8px]">
                      ...
                      <div className="[width:130px] [border-radius:12px] [box-shadow:0_4px_16px_rgba(0,0,0,0.15)] [aspect-ratio:9/16] [overflow:hidden]"><img src="/assets/toefl4.webp" alt="" className="[display:block] [width:100%] [height:100%] [object-fit:cover]" /></div>
                    </div>
                    ...
                    <div className="[margin:0_8px] [display:flex] [flex-shrink:0] [flex-direction:column] [align-items:center] [gap:8px]">
                      ...
                      <div className="[width:130px] [border-radius:12px] [box-shadow:0_4px_16px_rgba(0,0,0,0.15)] [aspect-ratio:9/16] [overflow:hidden]"><img src="/assets/toefl5.webp" alt="" className="[display:block] [width:100%] [height:100%] [object-fit:cover]" /></div>
                    </div>
                    ...
                    <div className="[margin:0_8px] [display:flex] [flex-shrink:0] [flex-direction:column] [align-items:center] [gap:8px]">
                      ...
                      <div className="[width:130px] [border-radius:12px] [box-shadow:0_4px_16px_rgba(0,0,0,0.15)] [aspect-ratio:9/16] [overflow:hidden]"><img src="/assets/toefl6.webp" alt="" className="[display:block] [width:100%] [height:100%] [object-fit:cover]" /></div>
                    </div>
                    ...
                    <div className="[margin:0_8px] [display:flex] [flex-shrink:0] [flex-direction:column] [align-items:center] [gap:8px]">
                      ...
                      <div className="[width:130px] [border-radius:12px] [box-shadow:0_4px_16px_rgba(0,0,0,0.15)] [aspect-ratio:9/16] [overflow:hidden]"><img src="/assets/toefl7.webp" alt="" className="[display:block] [width:100%] [height:100%] [object-fit:cover]" /></div>
                    </div>
                  
                    <div className="[margin:0_8px] [display:flex] [flex-shrink:0] [flex-direction:column] [align-items:center] [gap:8px]">
                      <p className="[margin:0] [font-size:16px] [font-weight:800] [font-family:Nunito,sans-serif] [color:#151515]">Skor <span className="[color:#D70808]">560</span></p>
                      <div className="[width:130px] [border-radius:12px] [box-shadow:0_4px_16px_rgba(0,0,0,0.15)] [aspect-ratio:9/16] [overflow:hidden]"><img src="/assets/toefl9.webp" alt="" className="[display:block] [width:100%] [height:100%] [object-fit:cover]" /></div>
                    </div>
                ...
                <div className="[display:grid] [grid-template-columns:repeat(auto-fit,minmax(280px,1fr))] [gap:16px]">
                    ...
                    <div className="[display:flex] [min-width:0] [flex-direction:column] [gap:12px] [border-radius:16px] [border:1px_solid_#f3f4f6] [padding:20px] [background:#F9F9F9] [box-shadow:0_2px_16px_rgba(0,0,0,0.05)]">
                      ...
                      <div className="[display:flex] [align-items:center] [gap:12px] [border-top:1px_solid_#f3f4f6] [padding-top:8px]">
                        <img src="/assets/People%201.webp" alt="Andi Manggala Putra" className="[height:40px] [width:40px] [flex-shrink:0] [border-radius:9999px] [object-fit:cover]" />
                    ...
                    <div className="[display:flex] [min-width:0] [flex-direction:column] [gap:12px] [border-radius:16px] [border:1px_solid_#f3f4f6] [padding:20px] [background:#F9F9F9] [box-shadow:0_2px_16px_rgba(0,0,0,0.05)]">
                      ...
                      <div className="[display:flex] [align-items:center] [gap:12px] [border-top:1px_solid_#f3f4f6] [padding-top:8px]">
                        <img src="/assets/People%202.webp" alt="Hajrah" className="[height:40px] [width:40px] [flex-shrink:0] [border-radius:9999px] [object-fit:cover]" />
                        <div className="[min-width:0] [flex:1]">
              ...
              <div className="[margin-top:48px]">
                ...
                <div className="[position:relative] [display:flex] [align-items:center] [justify-content:center] [height:220px] [overflow:hidden]">
                  ...
                  <img src={reviewSrc(gIdx)} onClick={() => setReviewIdx(gIdx)} alt="Google review alumni" className="[position:absolute] [left:50%] [transform:translateX(-50%)] [transition:all_0.3s_ease] [cursor:pointer] [height:210px] [width:auto] [max-width:340px] [border-radius:16px] [box-shadow:0_8px_28px_rgba(0,0,0,0.18)] [z-index:2] [object-fit:contain]" />
            ...
            <div className="[max-width:520px] [margin:0_auto_40px]">
              <div className="[border-radius:24px] [padding:28px] [display:flex] [flex-direction:column] [position:relative] [overflow:hidden] [border:2px_solid_#F5B700] [box-shadow:0_8px_32px_rgba(245,183,0,0.15)] [background:linear-gradient(165deg,#ffffff_0%,#fffbf0_100%)]">
                ...
                <div className="[display:flex] [flex-direction:column] [gap:6px]">
                  <TrackedCTA href="https://member.fullbrightindonesia.com/paket-gold-e-course-toefl" target="_blank" rel="noopener noreferrer" onClick={markCheckoutClicked} zone="pricing" action="external_checkout" label="Mulai Belajar Mandiri" className="[display:inline-flex] [width:100%] [align-items:center] [justify-content:center] [gap:8px] [font-weight:900] [border-radius:16px] [padding:16px_20px] [font-size:16px] [color:#fff] [background:#D70808] [box-shadow:0_6px_24px_rgba(215,8,8,0.4)] [text-decoration:none] [box-sizing:border-box]">Mulai Belajar Mandiri →</TrackedCTA>
                ...
                <TrackedCTA href="https://wa.me/6281959486507?text=Halo%20Admin%20Full%20Bright%20Indonesia.%20Saya%20minat%20mau%20daftar%20E-Course%20Self-Study%20LMS." target="_blank" rel="noopener noreferrer" zone="pricing" action="whatsapp" label="Tanya via WhatsApp Self-Study" className="[display:inline-flex] [width:100%] [align-items:center] [justify-content:center] [gap:8px] [font-weight:700] [border-radius:16px] [padding:12px_20px] [font-size:14px] [color:#16a34a] [background:transparent] [border:1.5px_solid_#25D366] [text-decoration:none] [box-sizing:border-box]"><img src="/assets/admin-avatar.webp" alt="Admin Full Bright" className="[width:26px] [height:26px] [border-radius:9999px] [object-fit:cover] [border:2px_solid_#25D366] [flex-shrink:0]" />💬 Tanya via WhatsApp</TrackedCTA>
                <p className="[margin:14px_0_0] [text-align:center] [font-size:13px] [line-height:1.5] [color:#9ca3af]">Mau intip materinya dulu? <TrackedCTA href="https://class.fullbrightindonesia.com/register" target="_blank" rel="noopener noreferrer" zone="pricing" action="link" label="Coba gratis 1 modul di LMS" className="[font-weight:800] [color:#6b7280] [text-decoration:underline] [text-underline-offset:3px]">Coba gratis 1 modul di LMS</TrackedCTA></p>
              </div>
            </div>
          ...
          <div className="[max-width:1152px] [margin:0_auto]">
            ...
            <div className="[display:grid] [grid-template-columns:repeat(auto-fit,minmax(300px,1fr))] [gap:24px] [margin-bottom:56px]">
              ...
              <div className="[border-radius:24px] [padding:28px] [border:2px_solid_#e5e7eb] [display:flex] [flex-direction:column] [box-shadow:0_4px_24px_rgba(0,0,0,0.06)]">
                ...
                <div className="[display:flex] [flex-direction:column] [gap:6px]">
                  <TrackedCTA href="https://member.fullbrightindonesia.com/paket-premium-toefl-level-starter-live-zoom-intensif-flash-sale" target="_blank" rel="noopener noreferrer" onClick={markCheckoutClicked} zone="pricing" action="external_checkout" label="Apply Starter" className="[display:inline-flex] [width:100%] [align-items:center] [justify-content:center] [gap:8px] [font-weight:900] [border-radius:16px] [padding:16px_20px] [font-size:16px] [color:#fff] [background:#D70808] [box-shadow:0_6px_24px_rgba(215,8,8,0.4)] [text-decoration:none] [box-sizing:border-box]">Apply Sekarang →</TrackedCTA>
                  <p className="[margin:0] [display:flex] [align-items:center] [justify-content:center] [gap:4px] [font-size:12px] [text-align:center] [color:#9ca3af]">🔒 Pembayaran aman &amp; terenkripsi</p>
                </div>
                <div className="[display:flex] [align-items:center] [gap:12px] [margin:12px_0]">
                  <div className="[flex:1] [height:1px] [background:#e5e7eb]"></div><span className="[font-size:12px] [font-weight:600] [color:#9ca3af]">atau</span><div className="[flex:1] [height:1px] [background:#e5e7eb]"></div>
                </div>
                <TrackedCTA href="https://wa.me/6281959486507?text=Halo%20Admin%20Full%20Bright%20Indonesia.%20Saya%20minat%20mau%20daftar%20kelas%20TOEFL%20Level%20Starter" target="_blank" rel="noopener noreferrer" zone="pricing" action="whatsapp" label="Tanya via WhatsApp Starter" className="[display:inline-flex] [width:100%] [align-items:center] [justify-content:center] [gap:8px] [font-weight:700] [border-radius:16px] [padding:12px_20px] [font-size:14px] [color:#16a34a] [background:transparent] [border:1.5px_solid_#25D366] [text-decoration:none] [box-sizing:border-box]"><img src="/assets/admin-avatar.webp" alt="Admin Full Bright" className="[width:26px] [height:26px] [border-radius:9999px] [object-fit:cover] [border:2px_solid_#25D366] [flex-shrink:0]" />💬 Tanya via WhatsApp</TrackedCTA>
              ...
              <div className="[border-radius:24px] [padding:28px] [display:flex] [flex-direction:column] [position:relative] [overflow:hidden] [border:2px_solid_#16a34a] [box-shadow:0_16px_56px_rgba(22,163,74,0.2),0_0_0_1px_rgba(22,163,74,0.08)] [background:linear-gradient(165deg,#ffffff_0%,#f0fdf4_100%)]">
                ...
                <div className="[display:flex] [flex-direction:column] [gap:6px]">
                  <TrackedCTA href="https://member.fullbrightindonesia.com/paket-premium-toefl-level-starter-live-zoom-intensif-flash-sale" target="_blank" rel="noopener noreferrer" onClick={markCheckoutClicked} zone="pricing" action="external_checkout" label="Apply Hemat Starter + Intermediate" className="[display:inline-flex] [width:100%] [align-items:center] [justify-content:center] [gap:8px] [font-weight:900] [border-radius:16px] [padding:16px_20px] [font-size:16px] [color:#fff] [background:#16a34a] [box-shadow:0_6px_24px_rgba(22,163,74,0.4)] [text-decoration:none] [box-sizing:border-box]">Apply Sekarang →</TrackedCTA>
                  <p className="[margin:0] [display:flex] [align-items:center] [justify-content:center] [gap:4px] [font-size:12px] [text-align:center] [color:#9ca3af]">🔒 Pembayaran aman &amp; terenkripsi</p>
                </div>
                ...
                <TrackedCTA href="https://wa.me/6281959486507?text=Halo%20Admin%20Full%20Bright%20Indonesia.%20Saya%20minat%20mau%20daftar%20paket%20HEMAT%20TOEFL%20Level%20Starter%20%2B%20Intermediate." target="_blank" rel="noopener noreferrer" zone="pricing" action="whatsapp" label="Tanya via WhatsApp Hemat" className="[display:inline-flex] [width:100%] [align-items:center] [justify-content:center] [gap:8px] [font-weight:700] [border-radius:16px] [padding:12px_20px] [font-size:14px] [color:#16a34a] [background:transparent] [border:1.5px_solid_#25D366] [text-decoration:none] [box-sizing:border-box]"><img src="/assets/admin-avatar.webp" alt="Admin Full Bright" className="[width:26px] [height:26px] [border-radius:9999px] [object-fit:cover] [border:2px_solid_#25D366] [flex-shrink:0]" />💬 Tanya via WhatsApp</TrackedCTA>
                <div className="[display:flex] [align-items:center] [justify-content:center] [flex-wrap:wrap] [gap:6px] [margin-top:14px]">
                  <span className="[display:inline-flex] [align-items:center] [gap:4px] [padding:4px_10px] [border-radius:9999px] [font-size:12px] [font-weight:600] [background:#FEF3C7] [color:#B45309]">★ 4.9/5</span>
                  <span className="[display:inline-flex] [align-items:center] [gap:4px] [padding:4px_10px] [border-radius:9999px] [font-size:12px] [font-weight:600] [background:#F0FDF4] [color:#15803d]">45.000+</span>
                  <span className="[display:inline-flex] [align-items:center] [gap:4px] [padding:4px_10px] [border-radius:9999px] [font-size:12px] [font-weight:600] [background:#EFF6FF] [color:#1d4ed8]">🛡 Garansi 100%</span>
              ...
              <div className="[border-radius:24px] [padding:28px] [border:2px_solid_#e5e7eb] [display:flex] [flex-direction:column] [box-shadow:0_4px_24px_rgba(0,0,0,0.06)]">
                ...
                <div className="[display:flex] [flex-direction:column] [gap:6px]">
                  <TrackedCTA href="https://member.fullbrightindonesia.com/paket-premium-toefl-level-intermediate-live-zoom-intensif-flash-sale" target="_blank" rel="noopener noreferrer" onClick={markCheckoutClicked} zone="pricing" action="external_checkout" label="Apply Intermediate" className="[display:inline-flex] [width:100%] [align-items:center] [justify-content:center] [gap:8px] [font-weight:900] [border-radius:16px] [padding:16px_20px] [font-size:16px] [color:#fff] [background:#D70808] [box-shadow:0_6px_24px_rgba(215,8,8,0.4)] [text-decoration:none] [box-sizing:border-box]">Apply Sekarang →</TrackedCTA>
                  <p className="[margin:0] [display:flex] [align-items:center] [justify-content:center] [gap:4px] [font-size:12px] [text-align:center] [color:#9ca3af]">🔒 Pembayaran aman &amp; terenkripsi</p>
                </div>
                <div className="[display:flex] [align-items:center] [gap:12px] [margin:12px_0]">
                  <div className="[flex:1] [height:1px] [background:#e5e7eb]"></div><span className="[font-size:12px] [font-weight:600] [color:#9ca3af]">atau</span><div className="[flex:1] [height:1px] [background:#e5e7eb]"></div>
                </div>
                <TrackedCTA href="https://wa.me/6281959486507?text=Halo%20Admin%20Full%20Bright%20Indonesia.%20Saya%20minat%20mau%20daftar%20kelas%20TOEFL%20Level%20Intermediate." target="_blank" rel="noopener noreferrer" zone="pricing" action="whatsapp" label="Tanya via WhatsApp Intermediate" className="[display:inline-flex] [width:100%] [align-items:center] [justify-content:center] [gap:8px] [font-weight:700] [border-radius:16px] [padding:12px_20px] [font-size:14px] [color:#16a34a] [background:transparent] [border:1.5px_solid_#25D366] [text-decoration:none] [box-sizing:border-box]"><img src="/assets/admin-avatar.webp" alt="Admin Full Bright" className="[width:26px] [height:26px] [border-radius:9999px] [object-fit:cover] [border:2px_solid_#25D366] [flex-shrink:0]" />💬 Tanya via WhatsApp</TrackedCTA>
                <div className="[display:flex] [align-items:center] [justify-content:center] [flex-wrap:wrap] [gap:6px] [margin-top:14px]">
                  <span className="[display:inline-flex] [align-items:center] [gap:4px] [padding:4px_10px] [border-radius:9999px] [font-size:12px] [font-weight:600] [background:#FEF3C7] [color:#B45309]">★ 4.9/5</span>
                  <span className="[display:inline-flex] [align-items:center] [gap:4px] [padding:4px_10px] [border-radius:9999px] [font-size:12px] [font-weight:600] [background:#F0FDF4] [color:#15803d]">45.000+</span>
                  <span className="[display:inline-flex] [align-items:center] [gap:4px] [padding:4px_10px] [border-radius:9999px] [font-size:12px] [font-weight:600] [background:#EFF6FF] [color:#1d4ed8]">🛡 Garansi 100%</span>
            ...
            <div className="[max-width:672px] [margin:0_auto_32px] [border-radius:16px] [padding:24px] [background:#F3F3F3] [border:1px_solid_#e5e7eb]">
              ...
              <TrackedCTA href="https://referensi.data.kemendikdasmen.go.id/pendidikan/npsn/K9998700" target="_blank" rel="noopener noreferrer" zone="midpage" action="link" label="Info Detail Legalitas" className="[display:inline-block] [margin-top:12px] [font-size:12px] [font-weight:600] [color:#D70808] [text-decoration:none]">Info Detail Legalitas →</TrackedCTA>
            </div>
      ...
      Catatan: Jika berhalangan hadir LIVE ZOOM, jangan khawatir — materi bisa diakses di rekaman ZOOM.</p>
            ...
            <div className="[max-width:512px] [margin:0_auto] [text-align:center]">
              ...
              <div className="[display:flex] [flex-wrap:wrap] [gap:12px] [justify-content:center]">
                <TrackedCTA href="https://wa.me/6281959486507?text=Halo%20Admin%20Full%20Bright%20Indonesia.%20Saya%20tertarik%20daftar%20kelas%20TOEFL%20Online." target="_blank" rel="noopener noreferrer" zone="faq" action="whatsapp" label="Chat Via WA" className="[display:inline-flex] [align-items:center] [justify-content:center] [gap:8px] [font-weight:700] [border-radius:16px] [padding:14px_28px] [font-size:16px] [color:#fff] [background:#D70808] [box-shadow:0_4px_20px_rgba(215,8,8,0.35)] [text-decoration:none]">Chat Via WA →</TrackedCTA>
                <TrackedCTA href="#testimonials" zone="midpage" action="scroll" label="Lihat Bukti Alumni" className="[display:inline-flex] [align-items:center] [justify-content:center] [gap:8px] [font-weight:700] [border-radius:16px] [padding:14px_28px] [font-size:16px] [color:#151515] [border:2px_solid_#D70808] [text-decoration:none]">Lihat Bukti Alumni →</TrackedCTA>
              </div>
            </div>
          </div>
            ...
            <div className="[display:grid] [grid-template-columns:repeat(auto-fit,minmax(240px,1fr))] [gap:40px] [margin-bottom:40px]">
              <div>
                ...
                <div className="[display:flex] [gap:12px]">
                  <TrackedCTA href="https://www.instagram.com/fulbrightindonesia/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" zone="footer" action="link" label="Instagram" className="[width:36px] [height:36px] [border-radius:12px] [display:flex] [align-items:center] [justify-content:center] [background:rgba(255,255,255,0.08)] [color:#9ca3af] [text-decoration:none]">
              ...
              <div>
                ...
                <ul className="[list-style:none] [margin:0] [padding:0] [display:flex] [flex-direction:column] [gap:12px]">
                  <li><TrackedCTA href="#value" zone="footer" action="scroll" label="Keunggulan" className="[font-size:14px] [color:#9ca3af] [text-decoration:none]">Keunggulan</TrackedCTA></li>
                  <li><TrackedCTA href="#testimonials" zone="footer" action="scroll" label="Testimoni" className="[font-size:14px] [color:#9ca3af] [text-decoration:none]">Testimoni</TrackedCTA></li>
                  <li><TrackedCTA href="#pricing" zone="footer" action="scroll" label="Harga" className="[font-size:14px] [color:#9ca3af] [text-decoration:none]">Harga</TrackedCTA></li>
                  <li><TrackedCTA href="#faq" zone="footer" action="scroll" label="FAQ" className="[font-size:14px] [color:#9ca3af] [text-decoration:none]">FAQ</TrackedCTA></li>
                </ul>
              </div>
                ...
                <ul className="[list-style:none] [margin:0] [padding:0] [display:flex] [flex-direction:column] [gap:16px]">
                    ...
                    <li className="[display:flex] [align-items:flex-start] [gap:12px]">
                      ...
                      <div>
                        ...
                        <TrackedCTA href="https://wa.me/6281959486507" zone="footer" action="whatsapp" label="WhatsApp 0819" className="[font-size:12px] [color:#9ca3af] [text-decoration:none]">+62 819-5948-6507</TrackedCTA>
                      </div>
                    </li>
                    ...
                    <li className="[display:flex] [align-items:flex-start] [gap:12px]">
                      ...
                      <div>
                        ...
                        <TrackedCTA href="https://wa.me/6288744875322" zone="footer" action="whatsapp" label="WhatsApp 0887" className="[font-size:12px] [color:#9ca3af] [text-decoration:none]">+62 887-4487-5322</TrackedCTA>
                      </div>
                    </li>
                    ...
                    <li className="[display:flex] [align-items:flex-start] [gap:12px]">
                      ...
                      <div>
                        ...
                        <TrackedCTA href="https://wa.me/6285255499299" zone="footer" action="whatsapp" label="WhatsApp 0852" className="[font-size:12px] [color:#9ca3af] [text-decoration:none]">+62 852-5549-9299</TrackedCTA>
                      </div>
                    </li>
                  ...
                  <li className="[display:flex] [align-items:flex-start] [gap:12px]">
                    ...
                    <div>
                      ...
                      <TrackedCTA href="mailto:info@fullbrightindonesia.org" zone="footer" action="link" label="Email" className="[font-size:12px] [color:#9ca3af] [text-decoration:none]">info@fullbrightindonesia.org</TrackedCTA>
                    </div>
                  </li>
                  <li className="[display:flex] [align-items:flex-start] [gap:12px]">
                    <div className="[width:32px] [height:32px] [border-radius:8px] [display:flex] [align-items:center] [justify-content:center] [flex-shrink:0] [margin-top:2px] [background:rgba(255,255,255,0.08)] [color:#9ca3af]">📍</div>
        ...
        {rpOpen ? (<>
          <div className="[position:fixed] [inset:0] [z-index:100] [display:flex] [align-items:flex-end] [justify-content:center] [background:rgba(21,21,21,0.45)] [animation:fbFadeInUp_0.2s_ease]" onClick={closeReturnPopup}>
            <div className="[position:relative] [width:100%] [max-width:480px] [max-height:60vh] [overflow-y:auto] [background:#fff] [border-radius:24px_24px_0_0] [padding:22px_22px_28px] [box-shadow:0_-12px_40px_rgba(0,0,0,0.18)] [animation:fbSheetUp_0.25s_ease]" onClick={(e) => e.stopPropagation()}>
              ...
              {rpSelected !== null ? (<>
                <TrackedCTA href={waUrl(RETURN_WA_MSGS[rpSelected ?? 0])} target="_blank" rel="noopener noreferrer" zone="floating" action="whatsapp" label="Konsultasi via WhatsApp" className="[display:flex] [align-items:center] [justify-content:center] [gap:8px] [width:100%] [font-size:14px] [font-weight:700] [color:#fff] [background:#16a34a] [border-radius:12px] [padding:13px_16px] [text-decoration:none] [box-sizing:border-box] [margin-bottom:14px]">💬 Konsultasi via WhatsApp →</TrackedCTA>
        ...
        <div className="[position:fixed] [right:48px] [bottom:20px] [z-index:52] [display:flex] [flex-direction:column] [align-items:flex-end] [gap:10px] max-[559px]:[right:28px]">
          {waBubbleOpen ? (<>
            <div className="max-[559px]:[max-width:208px] max-[559px]:[padding:10px_12px_10px_11px] max-[559px]:[border-radius:14px_14px_5px_14px] [position:relative] [max-width:270px] [border-radius:18px_18px_6px_18px] [background:#fff] [border:1px_solid_#e5e7eb] [box-shadow:0_10px_34px_rgba(0,0,0,0.18)] [padding:14px_16px_14px_14px]">
              ...
              <TrackedCTA href={whatsappUrl} target="_blank" rel="noopener noreferrer" zone="floating" action="whatsapp" label="WhatsApp Bubble" className="[display:flex] [align-items:flex-start] [gap:11px] [text-decoration:none]">
                <img src="/assets/admin-avatar.webp" alt="Admin Full Bright" className="max-[559px]:[width:28px] max-[559px]:[height:28px] [width:38px] [height:38px] [flex-shrink:0] [border-radius:9999px] [object-fit:cover] [border:2px_solid_#25D366]" />
                <span className="[display:block]">
                  <span className="max-[559px]:[font-size:10px] max-[559px]:[margin-bottom:2px] [display:block] [font-size:12px] [font-weight:900] [font-family:Nunito,sans-serif] [color:#151515] [margin-bottom:3px]">Ms. Fini - Admin Full Bright</span>
                  ...
                  <span className="[display:inline-block] [margin-top:8px] [font-size:12px] [font-weight:900] [color:#15803d]">Balas sekarang →</span>
                </span>
              </TrackedCTA>
            </div>
          </>) : null}
          <TrackedCTA href={whatsappUrl} target="_blank" rel="noopener noreferrer" aria-label="Chat WhatsApp" zone="floating" action="whatsapp" label="Floating WhatsApp" className="[position:relative] [display:flex] [height:58px] [width:58px] [align-items:center] [justify-content:center] [border-radius:9999px] [box-shadow:0_6px_22px_rgba(37,211,102,0.5)] [background:#25D366] [overflow:visible]">
